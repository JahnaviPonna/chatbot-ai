...
# # Set up API Key
# API_KEY = "AIzaSyDrkzsvbTU03fESOGxPYAWMe56dJpNS6L4"
# genai.configure(api_key=API_KEY)
...
#         for chat_id, messages in loaded_history.items():
#             if isinstance(messages, list):  # Old format detected
#                 loaded_history[chat_id] = {"name": f"Chat {chat_id}", "messages": messages}
...
# # Sidebar for chat list and new chat
# with st.sidebar:
...
#         st.session_state.chat_history[new_chat_id] = {"name": f"Chat {new_chat_id}", "messages": []}
...
#     # Display previous chats with menu button
...
#         # Menu button for renaming & deleting chat
#         with col2:
...
# # API_KEY = "AIzaSyDrkzsvbTU03fESOGxPYAWMe56dJpNS6L4"  # Replace with your Gemini API Key
# # genai.configure(api_key=API_KEY)
